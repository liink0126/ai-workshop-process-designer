...
- **'preparation' 객체를 반드시 포함해야 하며, 워크숍 실행을 위한 구체적인 준비 사항을 제공해야 합니다:**
    - **materials**: 워크숍에 필요한 모든 준비물을 구체적으로 나열한 문자열 배열 (예: ["A4 용지 50장", "포스트잇 5팩 (노란색, 분홍색, 초록색)", "마커펜 10자루", "플립차트 2대", "프로젝터 1대", "수성 싸인펜 (참여자 수만큼)"]). 참고: 필기용 펜이 필요한 경우 "네임펜" 대신 "수성 싸인펜"을 사용해야 합니다.
